...
exports.getUserByJWT = async function (req, res) {
  const { id } = req.user;
  try {
    UserModel.findUserById(id)
      .then((user) => {
...
exports.register = async function (req, res) {
  try {
    ...
    UserModel.findByEmail(email).then((results) => {
...
exports.updateRoleUser = async function (req, res) {
  ...
  try {
    UserModel.updateRoleUser(name, surname, email, phone, address, id, password)
      .then(() => {
        res.json({
          success: true,
          message: "User update successfull",
